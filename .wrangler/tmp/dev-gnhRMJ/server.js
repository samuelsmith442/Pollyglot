...
// .wrangler/tmp/bundle-dDqUCr/checked-fetch.js
...
async function handleRequest(request, env) {
  ...
  try {
    ...
    const messages = [
      {
        role: "system",
        content: "You are PollyGlot, an intelligent language translation assistant. You provide the translation text only, no extra words or explanations."
      },
      {
        role: "user",
...
// .wrangler/tmp/bundle-dDqUCr/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-dDqUCr/middleware-loader.entry.ts
